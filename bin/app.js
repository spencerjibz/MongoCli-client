...
.action((cmd,options)=>{
    ...
    {input:'editor',name:'updated',message:'enter the update Object in the editor'}
])
    .then(ans=>{
  let {q_type,q_name,updated} = ans,filter={[q_type]:q_name}
  
UpdateOne(cmd,options.collection,filter,updated)
