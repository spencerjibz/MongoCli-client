...
.action(function(){
 ...
 inquirer.prompt([{type:'input',name:'shellpath',message:'Enter the path to the mongo shell:'},{type:'input',name:'url',message:'Enter remote database connection string:'}])
.then(ans => {
